  ...
  return (
    <div className='justify-between text-sm custom-min:flex  '>
      ...
      <div className='inline-flex custom-max-tablet:flex custom-max-tablet:justify-end '>
        {/* Thông báo */}
        <Popover
          className='custom-mobile-s:hidden ml-3 flex cursor-pointer items-center py-1 hover:text-white/70'
          renderPopover={
        ...
        {/* Hỗ trợ */}
        <div className='custom-mobile-s:hidden custom-mobile-m:hidden ml-3 flex cursor-pointer items-center hover:text-white/70'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
            viewBox='0 0 24 24'
