      ...
      <div className='my-5'>
        ...
        <form className='mt-2'>
          <div className='flex items-start'>
            ...
            />
            <div className='mx-3 mt-1 h-[1px] fill-gray-300 flex-shrink-0'>
          ...
          <Button className='w-full h-[30px] uppercase text-white bg-orange text-sm hover:bg-orange/80 flex justify-center items-center'>
            Áp dụng
          </Button>
        </form>
      </div>
